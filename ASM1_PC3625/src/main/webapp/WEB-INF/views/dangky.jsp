...
.drop-down-enter[data-v-f3fb3dc8], .drop-down-leave-to[data-v-f3fb3dc8]
	{
...
.drop-down-enter-active[data-v-f3fb3dc8], .drop-down-leave-active[data-v-f3fb3dc8]
	{
	transition: all 0.15s
}

.move-left-enter[data-v-f3fb3dc8], .move-left-leave-to[data-v-f3fb3dc8]
	{
...
.move-left-enter-active[data-v-f3fb3dc8], .move-left-leave-active[data-v-f3fb3dc8]
	{
	transition: all 0.15s
}
...
h1[data-v-f3fb3dc8], h2[data-v-f3fb3dc8], h3[data-v-f3fb3dc8], h4[data-v-f3fb3dc8]
	{
	margin-top: 0
}
...
@media ( max-width : 991px) .bread-crumb .nd-main-title-breadcrumb {
	font-size
...
<body class="customers-login">
	<jsp:include page="header-dangky.jsp" />
	<!-- Section: Design Block -->
	<section class="form">
		<!-- Background image -->
		<div class="p-5 bg-image"
			style="background-image: url('../Asm-TaiNguyen/images/banner-dangky.jpg'); height: 300px;"></div>
		<!-- Background image -->
			...
			<div class="card-body py-5 px-md-5">
				<div class="page-login account-box-shadow">
					...
					<div id="login" class="row">
						...
						<div
							class="col-lg-12 col-md-12 account-content order-lg-last order-md-last order-sm-first order-first">

							<form method="post" action="/account/register"
								id="customer_register" accept-charset="UTF-8"
								class="has-validation-callback">
								<input name="FormType" type="hidden" value="customer_register"><input
									name="utf8" type="hidden" value="true"><input
									type="hidden" id="Token-b6207e9af52e466e9fa64ad525d6689f"
									name="Token"
									value="03AAYGu2TwHFb8e9p2fP6KOZNTFFFkllxYZaXNfgenxKQpU3zzVUEI1922JHxjGNWOqzPGmoB_T95YsFyV6-eFzxDatt9uybyp0lCas2fERcCYUSvnSH3YRl1MhnBjX9Vi4Mt4mxlb32LAuKsZBHNZsekOZVF8qhUALagh3XJ0wJ5v0Pv_qmWdWGZrn0afVuEyqcBhZHqOW6zIzN2jW5ONqnj_YepPZAaenJxn3GjTbgMrj9SvrpaEO8hAn7qZLTkrdRD87AZE4US5ENAjOdEhQK2XCTAOTbPb6P28d7P0eOSctqEZiGdaFoDG58wU1UioyIGOTnFfnirwlbAEJe7rDxlkxym8iAODvoGPcV2xVzkcbOZafrU0sXAf0YqCxSwWblyZ88-DCnpdW7ebDKes61PYFsFdrcGjqK7bcXZq86Fx53NJ9EbpT-SIF4Pqa5j78BLecUfLNXObLWwkxayq5qZ4R0bUpDFhV-S1wQoZw94d4dqju_yzLVttSrNBpZxBai7QBFgrSBv86UZz1oMTnJx5EKRu46ABXYCygH-zehiiycTz2MdvFb735XK4qPIAfPuwBew_DD957r7WcEVEtRz114O5o67jj12gO9u_nBhBlL-gXTBUod8">
								<script
											...
											.ready(function() {
												grecaptcha
														...
														.then(
																function(token) {
																	document
																			.getElementById("Token-b6207e9af52e466e9fa64ad525d6689f").value = token
																});
											});
								</script>
									...
									<div class="row">
										...
										<div class="col-md-12 text-center margin-top-10">
											<button type="submit" value="Đăng ký"
												class="btn btn-style btn-blues">Tạo tài khoản</button>
										</div>
									</div>
								</div>
							</form>
