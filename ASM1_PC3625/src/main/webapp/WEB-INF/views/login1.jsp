...
<link href="../Asm-TaiNguyen/css/login.css" rel="stylesheet" />
    <head>
        <meta charset="utf-8"/>
        <script type="text/javascript">
            ...
            NREUM.info = {
                ...
                "transactionName": "Jg1bREUOClsARUpHBhYRXF9ZEklZAEA=",
                "queueTime": 0,
                "applicationTime": 35,
                "agent": ""
            }
        ...
        <meta name="csrf-token" content="6cq8xbg10XZFe35FvOFCej0X3QjpceLTrfrsXfVRG5WpgVq2gd2iQ+xsgio2WPrjXe7IkJILdeWgf7SxqOytYA=="/>
        <title>Sign In | 3F STORE
    </title>
        ...
        <meta name="description" content="Sign in to your Dribbble account, the world’s leading community for designers to share, grow, and get hired">
        <meta name="itly-controller" content="sessions"/>
        <meta name="itly-action" content="new"/>
        <script src="https://accounts.google.com/gsi/client" async defer></script>
    </head>
    <body class="logged-out not-pro not-player not-self not-team not-on-team  dribbble-v1 sign-in">
        <div id="main-container">
            <section class="auth-sidebar">
                <div class="auth-sidebar-content">
                    <header>
                        <a href="/" class="logo">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 24" role="img" aria-labelledby="a33tw7g907nxba4s4wqih5dxu1z4hz3f" class="icon dribbble-logo">
                                <title id="a33tw7g907nxba4s4wqih5dxu1z4hz3f">3F STORE</title>
                        ...
                        <h1>Four Footed Friends</h1>
                    </header>
                    <div class="artwork">
                        <div class="artwork-image"></div>
                        <p class="artwork-attribution">
                            Art by
                  <a class="url" rel="contact" href="/karicca">PC03737</a>
                        </p>
                    </div>
                </div>
            </section>
            <section class="content">
                ...
                <main>
                    <div class="auth-content">
                        ...
                        <div class="auth-connections">
                            ...
                            <div class="google-connect-btn">
                                <div class="g_id_signin" data-type="standard" data-size="large" data-text="sign_in_with" data-logo_alignment="left" data-width="250" data-shape="rectangular" data-theme="filled_blue"></div>
                            </div>
                            <a class="auth-twitter form-btn" data-auth-action="Sign In" rel="nofollow" data-method="post" href="https://dribbble.com/auth/Twitter">
                                <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="a8avn7iq8puovs9yfuuaczk2c5lrc576" role="img" viewBox="0 0 24 24" class="icon ">
                                    <title id="a8avn7iq8puovs9yfuuaczk2c5lrc576">Twitter icon</title>
                        ...
                        <div class="auth-form sign-in-form">
                            <form action="/session" accept-charset="UTF-8" method="post">
                                ...
                                <input type="hidden" name="authenticity_token" value="ISLSSVzSxW5Ey5wn7BjtzYPKYNIzS0x+l12Yx35iyuUijQFds9/27UtL66V3eVagtW+GLR+PXWaPZ3HBH8pk+A=="/>
                                <div class="form-fields">
                                    <fieldset>
                                        <label for="login">Username or Email Address</label>
                                        <input type="text" name="login" id="login" tabindex="1" class="text-input" autocorrect="off" autocapitalize="off" data-cypress="email"/>
                                    </fieldset>
                                    <fieldset>
                                        <label for="password" class="password">
                                            Password <a href="/password_resets/new">Forgot password?</a>
                                        </label>
                    ...
                    <script src="https://cdn.dribbble.com/assets/packs/js/login-page.85153ccf2f509d950d5e.js"></script>
                </main>
            </section>
        </div>
        ...
        <script>
            ...
            if (window.location.pathname == "/") {
                ...
                Dribbble.Analytics.logDribbbleGAPageView("/session/new")
            }
